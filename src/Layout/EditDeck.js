...
function EditDeck({ deck, setDeck }) {
  ...
  return (
    <div>
     ...
     <div>
     <form>
     <h3 className="ml-3">Edit Deck</h3>
   <div className="mb-3">
     <label 
   ...
   <button type="submit" className="btn btn-primary ml-3 mb-3" onClick={handleCancel}>Cancel</button>
 
   <button type="submit" className="btn btn-primary ml-1 mb-3" onClick={saveHandler} >Save</button>
   </form>
   </div>
   </div>
  )
